// Script to retreive comments (webmentions) and get them into Hugo.// Credits: https://sebastiandedeyne.com/webmentions-on-a-static-site-with-github-actions/
...
fetchWebmentions().then(webmentions => {
  webmentions.forEach(webmention => {
    const slug = webmention["wm-target"]
      .replace("https://blog.geheimesite.nl/", "")
      .replace(/\/$/, "")
      .replace("/", "--");
